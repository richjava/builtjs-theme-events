                ...
                <div className="relative z-10">
                  ...
                  <div className="px-5 lg:px-10 mb-6">
                    ...
                    <div className="flex items-center flex-col lg:flex-row">
                      <Link className="flex flex-grow justify-center w-full mb-4 lg:mb-0 mr-0 lg:mr-2 py-3 lg:py-3 text-white text-center uppercase tracking-widest text-sm border border-white hover:bg-white hover:text-primary transition-colors duration-200" href={`event-items/${item.attributes.slug}`}>
                          More Info
                      </Link>
                      <Link
